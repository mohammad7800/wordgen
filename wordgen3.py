...
if args_dict['input'] is None and args_dict['make_wordlist'] is None and args_dict['combine_words'] is None and args_dict['remove_from'] is None and args_dict['join'] is None and args_dict['make_big_wordlist'] is None and len(argv) != 1:
